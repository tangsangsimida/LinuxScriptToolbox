...
register_translations("en", {
    ...
    "msg.service_enabling": "Enabling service {service}...",
    "msg.service_start_failed": "Failed to start service {service}.",
    "msg.service_starting": "Starting service {service}...",
    "msg.service_started": "Service {service} started (status: {status}).",
...
register_translations("zh", {
    ...
    "msg.service_enabling": "正在启用服务 {service}...",
    "msg.service_start_failed": "启动服务 {service} 失败。",
    "msg.service_starting": "正在启动服务 {service}...",
    "msg.service_started": "服务 {service} 已启动（状态：{status}）。",
