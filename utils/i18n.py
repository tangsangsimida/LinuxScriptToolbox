...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "tool.locale-setup.description": "Set timezone, Chinese locale, and install Rime with rime-ice",
        # Messages
        ...
        "msg.step_ibus": "[3/4] Installing IBus + Rime...",
        ...
        "msg.ibus_installed": "IBus + Rime installed.",
        "msg.ibus_failed": "Failed to install IBus + Rime.",
    ...
    "zh": {
        ...
        "tool.locale-setup.description": "设置时区、中文语言环境，安装 Rime 输入法和雾凇拼音",
        # Messages
        ...
        "msg.step_ibus": "[3/4] 安装 IBus + Rime...",
        ...
        "msg.ibus_installed": "IBus + Rime 已安装。",
        "msg.ibus_failed": "IBus + Rime 安装失败。",
