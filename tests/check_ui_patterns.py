...
#
# Args:
#     filepath: Path to the Python file to check / 要检查的 Python 文件路径
#
# Returns:
#     List of (lineno, pattern, suggestion) error tuples / 错误元组列表
...
#
# Args:
#     tools_dir: Path to the tools directory / 工具目录路径
#
# Returns:
#     Dict mapping relative file paths to error lists / 相对文件路径到错误列表的映射字典
